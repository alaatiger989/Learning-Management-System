 ...
 * @author Alaa_Sayed
 */
public class AssignmentsFrame extends javax.swing.JFrame {

    /**
     * Creates new form LecturesFrame
     */
    DefaultTableModel model ;
    private String requiredAss;
    ...
    public AssignmentsFrame() {
        ...
        jLabel3.setText("Assignments on " + SelectedCourseModel.getCourseName());
        model = (DefaultTableModel) jTable1.getModel();
        model.addColumn("Required Assignment");
        model.addColumn("Course Name");
        model.addColumn("Delivery Date");
        model.addColumn("Creator Name");
        
        jLabel9.setVisible(false);// required ass
        jLabel6.setVisible(false);// delivery date

        jTextField1.setVisible(false);
        jTextField2.setVisible(false);


        jButton3.setVisible(false); // add ass
        jButton1.setVisible(false); // update ass.
        jButton2.setVisible(false); // delete ass
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Assignments Management");
        ...
        jLabel9.setText("Required Assignemnt");
        ...
        jButton1.setText("Update Assignment");
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 550, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTable1.getSelectedRow() != -1) {
            new ProfUserControls().updateAssignment(jTextField1.getText(),jTextField2.getText(),SelectedCourseModel.getProfName(), SelectedCourseModel.getCourseName() , requiredAss);
            deleteRows();
            getAssignments();
        }
        else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if (jTable1.getSelectedRow() != -1) {
            new ProfUserControls().deleteAssignment(requiredAss);
            deleteRows();
            getAssignments();
        }
        else{
            JOptionPane.showMessageDialog(null, "Please Select Which Assignment from Table....");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(jTextField1.getText().length() > 0)
        {
            ...
            new ProfUserControls().addAssignment(jTextField1.getText(),jTextField2.getText(),SelectedCourseModel.getProfName(), SelectedCourseModel.getCourseName());
            deleteRows();
            getAssignments();
        }
        else{
            JOptionPane.showMessageDialog(null, "Please Required Assignment  is Required , Please Fill it Uniquely");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssignmentsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void getAssignments() {
        ...
        String query = "Select * from assignment where course_name = '"+SelectedCourseModel.getCourseName()+"'";
        try {
            ...
            while (myResObj.next()) {
                String requiredAss = myResObj.getString("required_assignment");
                String deliveryDate = myResObj.getString("delivery_date");
                String creatorName = myResObj.getString("creator_name");
                String courseName = myResObj.getString("course_name");
                
                model.addRow(new Object[]{requiredAss ,courseName , deliveryDate , creatorName});
            }
    ...
    private void initializeTextFields() {
        ...
        requiredAss = model.getValueAt(modelRow, 0).toString();
        deliveryDate = model.getValueAt(modelRow, 2).toString();
       
        
        jTextField1.setText(requiredAss);
        jTextField2.setText(deliveryDate);
    ...
    private void initPrivileges() {
        ...
        getLastUpdatesOnPrivileges();
        if(UserPrivilegesModel.isAddAssignment())
        {
            jLabel9.setVisible(UserPrivilegesModel.isAddLecture());// required ass
            jLabel6.setVisible(UserPrivilegesModel.isAddLecture());// delivery date
            
            jTextField1.setVisible(UserPrivilegesModel.isAddLecture());
            jTextField2.setVisible(UserPrivilegesModel.isAddLecture());
           
            
            jButton3.setVisible(UserPrivilegesModel.isAddAssignment()); // add ass
            jButton1.setVisible(UserPrivilegesModel.isUpdateAssignment()); // update ass.
            jButton2.setVisible(UserPrivilegesModel.isDeleteAssignment()); // delete ass
            
        }
        if(UserPrivilegesModel.isUpdateAssignment())
        {
            jLabel9.setVisible(UserPrivilegesModel.isUpdateAssignment());// required ass
            jLabel6.setVisible(UserPrivilegesModel.isUpdateAssignment());// delivery date
            
            jTextField1.setVisible(UserPrivilegesModel.isUpdateAssignment());
            jTextField2.setVisible(UserPrivilegesModel.isUpdateAssignment());
        ...
        if(UserPrivilegesModel.isDeleteAssignment())
        {
            jLabel9.setVisible(UserPrivilegesModel.isUpdateAssignment());// required ass
            jLabel6.setVisible(UserPrivilegesModel.isUpdateAssignment());// delivery date
        ...
        if(UserPrivilegesModel.isAddAssignment() && UserPrivilegesModel.isDeleteAssignment())
        {
            jLabel9.setVisible(UserPrivilegesModel.isAddAssignment());// required ass
            jLabel6.setVisible(UserPrivilegesModel.isAddAssignment());// delivery date
            
            jTextField1.setVisible(UserPrivilegesModel.isAddAssignment());
            jTextField2.setVisible(UserPrivilegesModel.isAddAssignment());
        ...
        if(UserPrivilegesModel.isUpdateAssignment() && UserPrivilegesModel.isDeleteAssignment())
        {
            jLabel9.setVisible(UserPrivilegesModel.isUpdateAssignment());// required ass
            jLabel6.setVisible(UserPrivilegesModel.isUpdateAssignment());// delivery date
