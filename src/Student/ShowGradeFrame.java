...
public class ShowGradeFrame extends javax.swing.JFrame {
    ...
    public ShowGradeFrame() {
        ...
        jLabel5.setText("Grades For Student " + UserModel.getFirstName() + " " + UserModel.getLastName());
        model = (DefaultTableModel) jTable1.getModel();
        model.addColumn("Course Name");
        model.addColumn("Exam Type");
        model.addColumn("Exam Date");
        model.addColumn("Student Grade");
        model.addColumn("Total Exam Grade");
        model.addColumn("Student Full Name");
        getStudentGrades();
    }
    ...
    private void getStudentGrades() {
        ...
        String query = "Select * from studentsgrades where student_username = '"+UserModel.getUsername()+"'";
        try {
            ...
            while (myResObj.next()) {
                ...
                String studentGrade = myResObj.getString("student_grade");
                String totalExamGrade = myResObj.getString("totalExamGrade");
                String firstName = myResObj.getString("student_first_name");
                String lastName = myResObj.getString("student_last_name");
                model.addRow(new Object[]{courseName, examType, examDate, studentGrade, totalExamGrade, firstName + " " + lastName});
            }
